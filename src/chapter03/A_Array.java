...
public class A_Array { // 클래스명 == 파일명(대문자로 시작)
	...
	public static void main(String[] args) {
		...
		System.out.println(scores[1]);
		System.out.println(scores[2]);
		//System.out.println(scores[3]); //java.lang.ArrayIndexOutOfBoundsException
		
		// == 배열의 선언과 동시에 초기화 == //
		// : new 연산자 사용 + 직접적인 요소 대입의 배욜 생성 시 길이 지정X
		...
		System.out.println(greet[4]); // hello
		System.out.println();
		
		//System.out.println(greet[5]); //java.lang.ArrayIndexOutOfBoundsException
		...
		System.out.println(fruits); // [Ljava.lang.String;@33c7353a
		...
		int originalLength = original.length; // 길이 3
