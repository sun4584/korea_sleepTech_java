...
public class B_Array {
	public static void main(String[] args) {
		...
		for(int score: scores) {
			//score 변수
			// : for문의 반복에서 배열의 요소를 순착적으로 담는 변수
...
//		}
		...
		for(int score: scores) { // score라는 변수에 scores에 있는 배열에 저장되어 있는 값을 대입
			total += score; // total의 값은 440
		}
		
		double average = total / lenght; // lenght는 배열의 갯수(길이) 즉 5 ,total에 lenght를 나눔, double를 사용해서 소수점까지 출력
