...
//		: 사과 꺼내기 - 순차적인 수를 보고 사용한 꺼내기(속도 빠름)
...
// EX) '기차' - 칸마다 서로 연결 정리
//		: 새로운 칸(객체) 추가 - 앞뒤 칸에 연결만 하면 가능(속도 빠름)
...
public class B_List {
	public static void main(String[] args) {
		...
		// 1초 = 1,000,000,000 나노 초
		System.out.println(startTime); // 10023561586200
		for(int i = 0; i < 222222; i++) {
			arrayListTest.add(0, 1); // 항상 맨 앞에 요소 삽입
		}
		...
		for(int i = 0; i < 222222; i++) {
			linkedListTest.add(0, 1); // 항상 맨 앞에 요소 삽입
		}
