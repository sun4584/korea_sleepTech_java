			...
			while (true) {
				...
				try {
					...
					case 5:
						...
						List<Item> priceReItems = manager.searchByPriceRange(minPrice, maxPrice);
						if (priceReItems.isEmpty()) {
							System.out.println("No items in price range");
						} else {
							for (Item item : priceReItems) {
								item.display();
							}
						}
						break;
					case 6:
						...
						System.out.println("Enter Quantity to add/subtrack");
