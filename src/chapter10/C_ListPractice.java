...
// : 명단이 가득찰 경우 대기열로 추가, 참가자가 떠나면 대기열의 다음 사람이 추가
...
class EventManagement {
	...
	void addToWautingQueue(String name) {
...
public class C_ListPractice {
	public static void main(String[] args) {
		...
		eventManagement.addToWautingQueue("정규민");
		eventManagement.addToWautingQueue("박성욱");
		eventManagement.addToWautingQueue("김소빈");
		eventManagement.addToWautingQueue("윤안나");
		...
		eventManagement.addToWautingQueue("이은우");
		eventManagement.addToWautingQueue("이혜지");
