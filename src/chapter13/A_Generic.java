...
//		구체적인 타입은 사용 지점에 지정할 수 있도록 하는 기능
...
class Pair<K, V> { // K: key, V: value
	...
	// 2) 제네릭 메서드
	// [접근제한자] <제네릭 타입> 반환타입 메서드명(매게변수...) { 구현부 }
...
public class A_Generic {
	public static void main(String[] args) {
		...
		//Pair.<Integer>print("안녕"); The parameterized method <Integer>print(Integer) of type Pair is not applicable for the arguments (String)
