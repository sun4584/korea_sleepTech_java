...
// - 주로 '상속관계'에 있는 클래스 간의 유연한 탕비 처리를 위해 사용
// - 물음표(?) 기호를 사용하여 표기
...
public class B_Generic {
	public static void main(String[] args) {
		...
		Basket<Integer> integerBasket = new Basket<>(); // 숫자를 담은 바구니
		...
		// ? : 어떤 타입이든 활용
		// >> 와일드 카드의 구조체에 값을 할당하는 경우 커파일러가 구제적인 타입을 확인할 수 없어 오류 발생
		List<?> list1 = new ArrayList<>();
		// list1.add(integerBasket);
		// list1.add("안녕")
		list1.add(null); // Object 값에는 반드시 null을 사용
		...
		//list.add(123); - 구체적인 숫자 값 추가 불가(타입 안정성 보장 불가)
