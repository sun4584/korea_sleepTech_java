...
public class Practice01 {
	public static void main(String[] args) {
		List<StudentClass> studentClasses = Arrays.asList(new StudentClass("이승아", 30, 4.3),
				new StudentClass("이도경", 32, 4.1), new StudentClass("이지희", 20, 3.8), 
				new StudentClass("이지훈", 25, 4.0),
				new StudentClass("이민경", 310, 3.5));
		...
		// >> Comparator 클래스 .comparing타입 정적 메서드를 활용
